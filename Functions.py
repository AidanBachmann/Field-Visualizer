...
def plot2D(particles,numParticles,numTimeSteps,numGridPoints,grid,gridx,gridy,makeGifs,clearFigures):
    colors = plt.cm.hsv(np.linspace(0,1,numParticles)) # Create unique color for each particle
...
def plot2DFieldNorms(particles,numParticles,numTimeSteps,numGridPoints,grid,gridx,gridy,makeGifs,clearFigures):
    colors = plt.cm.hsv(np.linspace(0,1,numParticles)) # Create unique color for each particle
    fig,ax = plt.subplots(1,2,figsize=(20,11))
    xyPlaneIdx = -1 # z slice to plot fields
...
def plot2DS(particles,numParticles,numTimeSteps,numGridPoints,grid,gridx,gridy,makeGifs,clearFigures): # Plot 2D Poynting field
    plt.figure(3)
    colors = plt.cm.hsv(np.linspace(0,1,numParticles)) # Create unique color for each particle
